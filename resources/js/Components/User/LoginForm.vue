                    ...
                    <form @submit.prevent="submit">
                        <div class="card-body">
                            ...
                            <span>
                                ...
                                <Link class="text-center ms-3 h6" href="/send-otp"> Forget Password </Link>  <!-- SendOTPPage -->
                            </span>
                            </div>
                        </div>
                    </form>
...
<script setup>
    import { Link, useForm, usePage, router } from "@inertiajs/vue3";  // Link for linking in page, useForm for data sending, usePage for response/data store, router for redirect from onepage to other
